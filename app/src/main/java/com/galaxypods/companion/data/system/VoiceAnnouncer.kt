...
class VoiceAnnouncer @Inject constructor(
    ...
    private fun formatLeft(ad: AirPodsAdvertisement): String =
        "왼쪽 이어폰 ${ad.leftBatteryPercent}퍼센트 남았습니다."

    private fun formatRight(ad: AirPodsAdvertisement): String =
        "오른쪽 이어폰 ${ad.rightBatteryPercent}퍼센트 남았습니다."
